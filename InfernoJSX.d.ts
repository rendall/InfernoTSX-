...
//      <Menu />
// );
// render(App() as VNode, document.getElementById('app'));

// rendall 170925: added lifecycle functions for functional components
// rendall 170929: made a slightly more surgical, less intrusive version

// Type definitions for InfernoJSX 16.0
// Project: http://facebook.github.io/InfernoJSX/
...
InfernoJSX attributes, such as key and ref, should also be accepted in props, but should not exist on element.props.
...
var element: InfernoJSX.CElement<ButtonProps, Button>;
InfernoJSX.cloneElement(element, { label: "label" });
// cloning with optional props requires a cast
InfernoJSX.cloneElement(element, <{ isDisabled?: boolean }>{ isDisabled: true });
// cloning with key or ref requires a cast
InfernoJSX.cloneElement(element, <InfernoJSX.ClassAttributes<Button>>{ ref: button => button.reset() });
InfernoJSX.cloneElement(element, <{ isDisabled?: boolean } & InfernoJSX.Attributes>{
    key: "disabledButton",
    isDisabled: true
});
*/
...
declare namespace InfernoJSX {
    //
    // InfernoJSX Elements
    // ----------------------------------------------------------------------

    type InfernoJSXType = string | ComponentType<any>;
    type ComponentType<P = {}> = ComponentClass<P> | StatelessComponent<P>;

    type Key = string | number;
    type Ref<T> = VNodeRef;// string | ((instance: T | null) => any);
    ...
    // InfernoJSXHTML for InfernoJSXHTMLElement
    // tslint:disable-next-line:no-empty-interface
    interface InfernoJSXHTMLElement<T extends HTMLElement> extends DetailedInfernoJSXHTMLElement<AllHTMLAttributes<T>, T> { }

    interface DetailedInfernoJSXHTMLElement<P extends HTMLAttributes<T>, T extends HTMLElement> extends DOMElement<P, T> {
        type: keyof InfernoJSXHTML;
    }

    // InfernoJSXSVG for InfernoJSXSVGElement
    interface InfernoJSXSVGElement extends DOMElement<SVGAttributes<SVGElement>, SVGElement> {
        type: keyof InfernoJSXSVG;
    }
    ...
    interface DetailedHTMLFactory<P extends HTMLAttributes<T>, T extends HTMLElement> extends DOMFactory<P, T> {
        (props?: ClassAttributes<T> & P | null, ...children: InfernoJSXNode[]): DetailedInfernoJSXHTMLElement<P, T>;
    }

    interface SVGFactory extends DOMFactory<SVGAttributes<SVGElement>, SVGElement> {
        (props?: ClassAttributes<SVGElement> & SVGAttributes<SVGElement> | null, ...children: InfernoJSXNode[]): InfernoJSXSVGElement;
    }

    //
    // InfernoJSX Nodes
    // http://facebook.github.io/InfernoJSX/docs/glossary.html
    // ----------------------------------------------------------------------

    type InfernoJSXText = string | number;
    type InfernoJSXChild = InfernoJSXElement<any> | InfernoJSXText;

    // Should be Array<InfernoJSXNode> but type aliases cannot be recursive
    type InfernoJSXFragment = {} | Array<InfernoJSXChild | any[] | boolean>;
    type InfernoJSXNode = InfernoJSXChild | InfernoJSXFragment | boolean | null | undefined;
    ...
    function createFactory<T extends HTMLElement>(
        type: keyof InfernoJSXHTML): HTMLFactory<T>;
    function createFactory(
        type: keyof InfernoJSXSVG): SVGFactory;
    ...
    // DOM Elements
    // TODO: generalize this to everything in `keyof InfernoJSXHTML`, not just "input"
    function createElement(
        type: "input",
        props?: InputHTMLAttributes<HTMLInputElement> & ClassAttributes<HTMLInputElement>,
        ...children: InfernoJSXNode[]): DetailedInfernoJSXHTMLElement<InputHTMLAttributes<HTMLInputElement>, HTMLInputElement>;
    function createElement<P extends HTMLAttributes<T>, T extends HTMLElement>(
        type: keyof InfernoJSXHTML,
        props?: ClassAttributes<T> & P,
        ...children: InfernoJSXNode[]): DetailedInfernoJSXHTMLElement<P, T>;
    function createElement<P extends SVGAttributes<T>, T extends SVGElement>(
        type: keyof InfernoJSXSVG,
        props?: ClassAttributes<T> & P,
        ...children: InfernoJSXNode[]): InfernoJSXSVGElement;
    ...
    // DOM Elements
    // InfernoJSXHTMLElement
    function cloneElement<P extends HTMLAttributes<T>, T extends HTMLElement>(
        element: DetailedInfernoJSXHTMLElement<P, T>,
        props?: P,
        ...children: InfernoJSXNode[]): DetailedInfernoJSXHTMLElement<P, T>;
    // InfernoJSXHTMLElement, less specific
    function cloneElement<P extends HTMLAttributes<T>, T extends HTMLElement>(
        element: InfernoJSXHTMLElement<T>,
        props?: P,
        ...children: InfernoJSXNode[]): InfernoJSXHTMLElement<T>;
    // SVGElement
    function cloneElement<P extends SVGAttributes<T>, T extends SVGElement>(
        element: InfernoJSXSVGElement,
        props?: P,
        ...children: InfernoJSXNode[]): InfernoJSXSVGElement;
    ...
    function isValidElement<P>(object: {}): object is InfernoJSXElement<P>;

    const DOM: InfernoJSXDOM;
    const PropTypes: InfernoJSXPropTypes;
    const Children: InfernoJSXChildren;
    ...
    class Component<P, S> {
        ...
        render(props:any): JSX.Element | null | false;

        // InfernoJSX.Props<T> is now deprecated, which means that the `children`
        // property is not available on `P` by default, even though you can
        // always pass children as variadic arguments to `createElement`.
        // In the future, if we can define its call signature conditionally
        // on the existence of `children` in `P`, then we should remove this.
        props: Readonly<{ children?: InfernoJSXNode }> & Readonly<P>;
        state: Readonly<S>;
        context: any;
        // refs: {
        //     [key: string]: InfernoJSXInstance
        // };
    }
    ...
    interface StatelessComponent<P = {}> {
        (props: P & { children?: InfernoJSXNode }, context?: any): InfernoJSXElement<any> | null;
    ...
    interface ComponentLifecycle<P, S> {
         ...
         * InfernoJSX may call this even if props have not changed, so be sure to compare new and existing
    ...
    interface ComponentSpec<P, S> extends Mixin<P, S> {
        render(): InfernoJSXElement<any> | null;
    ...
    type InfernoJSXEventHandler<T> = EventHandler<SyntheticEvent<T>>;
    ...
    interface DOMAttributes<T> {
        ...
        // Image Events
        onLoad?: InfernoJSXEventHandler<T>;
        onLoadCapture?: InfernoJSXEventHandler<T>;
        onError?: InfernoJSXEventHandler<T>; // also a Media Event
        onErrorCapture?: InfernoJSXEventHandler<T>; // also a Media Event
        ...
        // Media Events
        onAbort?: InfernoJSXEventHandler<T>;
        onAbortCapture?: InfernoJSXEventHandler<T>;
        onCanPlay?: InfernoJSXEventHandler<T>;
        onCanPlayCapture?: InfernoJSXEventHandler<T>;
        onCanPlayThrough?: InfernoJSXEventHandler<T>;
        onCanPlayThroughCapture?: InfernoJSXEventHandler<T>;
        onDurationChange?: InfernoJSXEventHandler<T>;
        onDurationChangeCapture?: InfernoJSXEventHandler<T>;
        onEmptied?: InfernoJSXEventHandler<T>;
        onEmptiedCapture?: InfernoJSXEventHandler<T>;
        onEncrypted?: InfernoJSXEventHandler<T>;
        onEncryptedCapture?: InfernoJSXEventHandler<T>;
        onEnded?: InfernoJSXEventHandler<T>;
        onEndedCapture?: InfernoJSXEventHandler<T>;
        onLoadedData?: InfernoJSXEventHandler<T>;
        onLoadedDataCapture?: InfernoJSXEventHandler<T>;
        onLoadedMetadata?: InfernoJSXEventHandler<T>;
        onLoadedMetadataCapture?: InfernoJSXEventHandler<T>;
        onLoadStart?: InfernoJSXEventHandler<T>;
        onLoadStartCapture?: InfernoJSXEventHandler<T>;
        onPause?: InfernoJSXEventHandler<T>;
        onPauseCapture?: InfernoJSXEventHandler<T>;
        onPlay?: InfernoJSXEventHandler<T>;
        onPlayCapture?: InfernoJSXEventHandler<T>;
        onPlaying?: InfernoJSXEventHandler<T>;
        onPlayingCapture?: InfernoJSXEventHandler<T>;
        onProgress?: InfernoJSXEventHandler<T>;
        onProgressCapture?: InfernoJSXEventHandler<T>;
        onRateChange?: InfernoJSXEventHandler<T>;
        onRateChangeCapture?: InfernoJSXEventHandler<T>;
        onSeeked?: InfernoJSXEventHandler<T>;
        onSeekedCapture?: InfernoJSXEventHandler<T>;
        onSeeking?: InfernoJSXEventHandler<T>;
        onSeekingCapture?: InfernoJSXEventHandler<T>;
        onStalled?: InfernoJSXEventHandler<T>;
        onStalledCapture?: InfernoJSXEventHandler<T>;
        onSuspend?: InfernoJSXEventHandler<T>;
        onSuspendCapture?: InfernoJSXEventHandler<T>;
        onTimeUpdate?: InfernoJSXEventHandler<T>;
        onTimeUpdateCapture?: InfernoJSXEventHandler<T>;
        onVolumeChange?: InfernoJSXEventHandler<T>;
        onVolumeChangeCapture?: InfernoJSXEventHandler<T>;
        onWaiting?: InfernoJSXEventHandler<T>;
        onWaitingCapture?: InfernoJSXEventHandler<T>;
        ...
        // Selection Events
        onSelect?: InfernoJSXEventHandler<T>;
        onSelectCapture?: InfernoJSXEventHandler<T>;
    ...
    // unitless numbers are listed here (see CSSProperty.js in InfernoJSX)
    interface CSSProperties {
        ...
        /**
         * Determines whether or not the â€œbackâ€ side of a transformed element is visible when facing the viewer.
         */
         ...
         * corresponding element of background-image. If a property doesnâ€™t have enough comma-separated values to match the number of layers,
         ...
         *      â€¢       border-top-color
         *      â€¢       border-right-color
         *      â€¢       border-bottom-color
         *      â€¢       border-left-color The default color is the currentColor of each of these values.
         ...
         * Note that you can use the corresponding longhand properties to set specific individual properties of the left border â€” border-left-width,
         ...
         * individual properties of the right border â€” border-right-width, border-right-style and border-right-color.
         */
         ...
         * in a single declaration. Note that you can use the corresponding longhand properties to set specific
         * individual properties of the top border â€” border-top-width, border-top-style and border-top-color.
         */
        ...
        /**
         * The â€˜fillâ€™ property paints the interior of the given graphical element.
         ...
         * and the interior is determined according to the rules associated with the current value of the â€˜fill-ruleâ€™ property.
        ...
        /**
         * The â€˜fill-ruleâ€™ property indicates the algorithm which is to be used to determine what parts of the canvas are included inside the shape.
         ...
         * The â€˜fill-ruleâ€™ property provides two options for how the inside of a shape is determined:
         */
        ...
        /**
         * Determines a grid itemâ€™s placement by specifying the block-end. A grid item's placement in a grid area consists of a grid position and a grid span.
         ...
         * Each sizing function can be specified as a length, a percentage of the grid containerâ€™s size,
        ...
        /**
         * Indicates the maximum number of successive hyphenated lines in an element. The â€˜no-limitâ€™ value means that there is no limit.
         */
         ...
         *      â€¢       Outlines do not take up space, they are drawn above the content.
         *      â€¢       Outlines may be non-rectangular. They are rectangular in Gecko/Firefox.
        ...
        /**
         * Specifies what parts of an elementâ€™s content are skipped over when applying any text decoration.
         */
         ...
         * It can be clipped, display an ellipsis ('â€¦', U+2026 HORIZONTAL ELLIPSIS) or a Web author-defined string.
        ...
        /**
         * Defines when the transition will start. A value of â€˜0sâ€™ means the transition will execute as soon as the property is changed.
    ...
    interface HTMLAttributes<T> extends DOMAttributes<T> {
        // InfernoJSX-specific Attributes
    ...
    // that InfernoJSX supports, but the types can be improved.
    // Full list here: https://facebook.github.io/InfernoJSX/docs/dom-elements.html
    //
    ...
    interface InfernoJSXDOM extends InfernoJSXHTML, InfernoJSXSVG { }

    //
    // InfernoJSX.PropTypes
    // ----------------------------------------------------------------------
    ...
    interface InfernoJSXChildren {
        map<T>(children: InfernoJSXNode, fn: (child: InfernoJSXChild, index: number) => T): T[];
        forEach(children: InfernoJSXNode, fn: (child: InfernoJSXChild, index: number) => any): void;
...
declare global {
    namespace JSX {
        ...
        interface Element extends InfernoJSX.InfernoJSXElement<any> {}
        interface ElementClass extends InfernoJSX.Component<any> {
            render(props:any): Element | null | false;
        }
        interface ElementAttributesProperty { props: {}; }
        interface ElementChildrenAttribute { children: {}; }

        interface IntrinsicAttributes extends InfernoJSX.Attributes { }
        interface IntrinsicClassAttributes<T> extends InfernoJSX.ClassAttributes<T> { }
        // tslint:enable:no-empty-interface

        interface IntrinsicElements {
            // HTML
            a: InfernoJSX.DetailedHTMLProps<InfernoJSX.AnchorHTMLAttributes<HTMLAnchorElement>, HTMLAnchorElement>;
            abbr: InfernoJSX.DetailedHTMLProps<InfernoJSX.HTMLAttributes<HTMLElement>, HTMLElement>;
            address: InfernoJSX.DetailedHTMLProps<InfernoJSX.HTMLAttributes<HTMLElement>, HTMLElement>;
            area: InfernoJSX.DetailedHTMLProps<InfernoJSX.AreaHTMLAttributes<HTMLAreaElement>, HTMLAreaElement>;
            article: InfernoJSX.DetailedHTMLProps<InfernoJSX.HTMLAttributes<HTMLElement>, HTMLElement>;
            aside: InfernoJSX.DetailedHTMLProps<InfernoJSX.HTMLAttributes<HTMLElement>, HTMLElement>;
            audio: InfernoJSX.DetailedHTMLProps<InfernoJSX.AudioHTMLAttributes<HTMLAudioElement>, HTMLAudioElement>;
            b: InfernoJSX.DetailedHTMLProps<InfernoJSX.HTMLAttributes<HTMLElement>, HTMLElement>;
            base: InfernoJSX.DetailedHTMLProps<InfernoJSX.BaseHTMLAttributes<HTMLBaseElement>, HTMLBaseElement>;
            bdi: InfernoJSX.DetailedHTMLProps<InfernoJSX.HTMLAttributes<HTMLElement>, HTMLElement>;
            bdo: InfernoJSX.DetailedHTMLProps<InfernoJSX.HTMLAttributes<HTMLElement>, HTMLElement>;
            big: InfernoJSX.DetailedHTMLProps<InfernoJSX.HTMLAttributes<HTMLElement>, HTMLElement>;
            blockquote: InfernoJSX.DetailedHTMLProps<InfernoJSX.BlockquoteHTMLAttributes<HTMLElement>, HTMLElement>;
            body: InfernoJSX.DetailedHTMLProps<InfernoJSX.HTMLAttributes<HTMLBodyElement>, HTMLBodyElement>;
            br: InfernoJSX.DetailedHTMLProps<InfernoJSX.HTMLAttributes<HTMLBRElement>, HTMLBRElement>;
            button: InfernoJSX.DetailedHTMLProps<InfernoJSX.ButtonHTMLAttributes<HTMLButtonElement>, HTMLButtonElement>;
            canvas: InfernoJSX.DetailedHTMLProps<InfernoJSX.CanvasHTMLAttributes<HTMLCanvasElement>, HTMLCanvasElement>;
            caption: InfernoJSX.DetailedHTMLProps<InfernoJSX.HTMLAttributes<HTMLElement>, HTMLElement>;
            cite: InfernoJSX.DetailedHTMLProps<InfernoJSX.HTMLAttributes<HTMLElement>, HTMLElement>;
            code: InfernoJSX.DetailedHTMLProps<InfernoJSX.HTMLAttributes<HTMLElement>, HTMLElement>;
            col: InfernoJSX.DetailedHTMLProps<InfernoJSX.ColHTMLAttributes<HTMLTableColElement>, HTMLTableColElement>;
            colgroup: InfernoJSX.DetailedHTMLProps<InfernoJSX.ColgroupHTMLAttributes<HTMLTableColElement>, HTMLTableColElement>;
            data: InfernoJSX.DetailedHTMLProps<InfernoJSX.HTMLAttributes<HTMLElement>, HTMLElement>;
            datalist: InfernoJSX.DetailedHTMLProps<InfernoJSX.HTMLAttributes<HTMLDataListElement>, HTMLDataListElement>;
            dd: InfernoJSX.DetailedHTMLProps<InfernoJSX.HTMLAttributes<HTMLElement>, HTMLElement>;
            del: InfernoJSX.DetailedHTMLProps<InfernoJSX.DelHTMLAttributes<HTMLElement>, HTMLElement>;
            details: InfernoJSX.DetailedHTMLProps<InfernoJSX.DetailsHTMLAttributes<HTMLElement>, HTMLElement>;
            dfn: InfernoJSX.DetailedHTMLProps<InfernoJSX.HTMLAttributes<HTMLElement>, HTMLElement>;
            dialog: InfernoJSX.DetailedHTMLProps<InfernoJSX.HTMLAttributes<HTMLElement>, HTMLElement>;
            div: InfernoJSX.DetailedHTMLProps<InfernoJSX.HTMLAttributes<HTMLDivElement>, HTMLDivElement>;
            dl: InfernoJSX.DetailedHTMLProps<InfernoJSX.HTMLAttributes<HTMLDListElement>, HTMLDListElement>;
            dt: InfernoJSX.DetailedHTMLProps<InfernoJSX.HTMLAttributes<HTMLElement>, HTMLElement>;
            em: InfernoJSX.DetailedHTMLProps<InfernoJSX.HTMLAttributes<HTMLElement>, HTMLElement>;
            embed: InfernoJSX.DetailedHTMLProps<InfernoJSX.EmbedHTMLAttributes<HTMLEmbedElement>, HTMLEmbedElement>;
            fieldset: InfernoJSX.DetailedHTMLProps<InfernoJSX.FieldsetHTMLAttributes<HTMLFieldSetElement>, HTMLFieldSetElement>;
            figcaption: InfernoJSX.DetailedHTMLProps<InfernoJSX.HTMLAttributes<HTMLElement>, HTMLElement>;
            figure: InfernoJSX.DetailedHTMLProps<InfernoJSX.HTMLAttributes<HTMLElement>, HTMLElement>;
            footer: InfernoJSX.DetailedHTMLProps<InfernoJSX.HTMLAttributes<HTMLElement>, HTMLElement>;
            form: InfernoJSX.DetailedHTMLProps<InfernoJSX.FormHTMLAttributes<HTMLFormElement>, HTMLFormElement>;
            h1: InfernoJSX.DetailedHTMLProps<InfernoJSX.HTMLAttributes<HTMLHeadingElement>, HTMLHeadingElement>;
            h2: InfernoJSX.DetailedHTMLProps<InfernoJSX.HTMLAttributes<HTMLHeadingElement>, HTMLHeadingElement>;
            h3: InfernoJSX.DetailedHTMLProps<InfernoJSX.HTMLAttributes<HTMLHeadingElement>, HTMLHeadingElement>;
            h4: InfernoJSX.DetailedHTMLProps<InfernoJSX.HTMLAttributes<HTMLHeadingElement>, HTMLHeadingElement>;
            h5: InfernoJSX.DetailedHTMLProps<InfernoJSX.HTMLAttributes<HTMLHeadingElement>, HTMLHeadingElement>;
            h6: InfernoJSX.DetailedHTMLProps<InfernoJSX.HTMLAttributes<HTMLHeadingElement>, HTMLHeadingElement>;
            head: InfernoJSX.DetailedHTMLProps<InfernoJSX.HTMLAttributes<HTMLHeadElement>, HTMLHeadElement>;
            header: InfernoJSX.DetailedHTMLProps<InfernoJSX.HTMLAttributes<HTMLElement>, HTMLElement>;
            hgroup: InfernoJSX.DetailedHTMLProps<InfernoJSX.HTMLAttributes<HTMLElement>, HTMLElement>;
            hr: InfernoJSX.DetailedHTMLProps<InfernoJSX.HTMLAttributes<HTMLHRElement>, HTMLHRElement>;
            html: InfernoJSX.DetailedHTMLProps<InfernoJSX.HtmlHTMLAttributes<HTMLHtmlElement>, HTMLHtmlElement>;
            i: InfernoJSX.DetailedHTMLProps<InfernoJSX.HTMLAttributes<HTMLElement>, HTMLElement>;
            iframe: InfernoJSX.DetailedHTMLProps<InfernoJSX.IframeHTMLAttributes<HTMLIFrameElement>, HTMLIFrameElement>;
            img: InfernoJSX.DetailedHTMLProps<InfernoJSX.ImgHTMLAttributes<HTMLImageElement>, HTMLImageElement>;
            input: InfernoJSX.DetailedHTMLProps<InfernoJSX.InputHTMLAttributes<HTMLInputElement>, HTMLInputElement>;
            ins: InfernoJSX.DetailedHTMLProps<InfernoJSX.InsHTMLAttributes<HTMLModElement>, HTMLModElement>;
            kbd: InfernoJSX.DetailedHTMLProps<InfernoJSX.HTMLAttributes<HTMLElement>, HTMLElement>;
            keygen: InfernoJSX.DetailedHTMLProps<InfernoJSX.KeygenHTMLAttributes<HTMLElement>, HTMLElement>;
            label: InfernoJSX.DetailedHTMLProps<InfernoJSX.LabelHTMLAttributes<HTMLLabelElement>, HTMLLabelElement>;
            legend: InfernoJSX.DetailedHTMLProps<InfernoJSX.HTMLAttributes<HTMLLegendElement>, HTMLLegendElement>;
            li: InfernoJSX.DetailedHTMLProps<InfernoJSX.LiHTMLAttributes<HTMLLIElement>, HTMLLIElement>;
            link: InfernoJSX.DetailedHTMLProps<InfernoJSX.LinkHTMLAttributes<HTMLLinkElement>, HTMLLinkElement>;
            main: InfernoJSX.DetailedHTMLProps<InfernoJSX.HTMLAttributes<HTMLElement>, HTMLElement>;
            map: InfernoJSX.DetailedHTMLProps<InfernoJSX.MapHTMLAttributes<HTMLMapElement>, HTMLMapElement>;
            mark: InfernoJSX.DetailedHTMLProps<InfernoJSX.HTMLAttributes<HTMLElement>, HTMLElement>;
            menu: InfernoJSX.DetailedHTMLProps<InfernoJSX.MenuHTMLAttributes<HTMLElement>, HTMLElement>;
            menuitem: InfernoJSX.DetailedHTMLProps<InfernoJSX.HTMLAttributes<HTMLElement>, HTMLElement>;
            meta: InfernoJSX.DetailedHTMLProps<InfernoJSX.MetaHTMLAttributes<HTMLMetaElement>, HTMLMetaElement>;
            meter: InfernoJSX.DetailedHTMLProps<InfernoJSX.MeterHTMLAttributes<HTMLElement>, HTMLElement>;
            nav: InfernoJSX.DetailedHTMLProps<InfernoJSX.HTMLAttributes<HTMLElement>, HTMLElement>;
            noindex: InfernoJSX.DetailedHTMLProps<InfernoJSX.HTMLAttributes<HTMLElement>, HTMLElement>;
            noscript: InfernoJSX.DetailedHTMLProps<InfernoJSX.HTMLAttributes<HTMLElement>, HTMLElement>;
            object: InfernoJSX.DetailedHTMLProps<InfernoJSX.ObjectHTMLAttributes<HTMLObjectElement>, HTMLObjectElement>;
            ol: InfernoJSX.DetailedHTMLProps<InfernoJSX.OlHTMLAttributes<HTMLOListElement>, HTMLOListElement>;
            optgroup: InfernoJSX.DetailedHTMLProps<InfernoJSX.OptgroupHTMLAttributes<HTMLOptGroupElement>, HTMLOptGroupElement>;
            option: InfernoJSX.DetailedHTMLProps<InfernoJSX.OptionHTMLAttributes<HTMLOptionElement>, HTMLOptionElement>;
            output: InfernoJSX.DetailedHTMLProps<InfernoJSX.OutputHTMLAttributes<HTMLElement>, HTMLElement>;
            p: InfernoJSX.DetailedHTMLProps<InfernoJSX.HTMLAttributes<HTMLParagraphElement>, HTMLParagraphElement>;
            param: InfernoJSX.DetailedHTMLProps<InfernoJSX.ParamHTMLAttributes<HTMLParamElement>, HTMLParamElement>;
            picture: InfernoJSX.DetailedHTMLProps<InfernoJSX.HTMLAttributes<HTMLElement>, HTMLElement>;
            pre: InfernoJSX.DetailedHTMLProps<InfernoJSX.HTMLAttributes<HTMLPreElement>, HTMLPreElement>;
            progress: InfernoJSX.DetailedHTMLProps<InfernoJSX.ProgressHTMLAttributes<HTMLProgressElement>, HTMLProgressElement>;
            q: InfernoJSX.DetailedHTMLProps<InfernoJSX.QuoteHTMLAttributes<HTMLQuoteElement>, HTMLQuoteElement>;
            rp: InfernoJSX.DetailedHTMLProps<InfernoJSX.HTMLAttributes<HTMLElement>, HTMLElement>;
            rt: InfernoJSX.DetailedHTMLProps<InfernoJSX.HTMLAttributes<HTMLElement>, HTMLElement>;
            ruby: InfernoJSX.DetailedHTMLProps<InfernoJSX.HTMLAttributes<HTMLElement>, HTMLElement>;
            s: InfernoJSX.DetailedHTMLProps<InfernoJSX.HTMLAttributes<HTMLElement>, HTMLElement>;
            samp: InfernoJSX.DetailedHTMLProps<InfernoJSX.HTMLAttributes<HTMLElement>, HTMLElement>;
            script: InfernoJSX.DetailedHTMLProps<InfernoJSX.ScriptHTMLAttributes<HTMLScriptElement>, HTMLScriptElement>;
            section: InfernoJSX.DetailedHTMLProps<InfernoJSX.HTMLAttributes<HTMLElement>, HTMLElement>;
            select: InfernoJSX.DetailedHTMLProps<InfernoJSX.SelectHTMLAttributes<HTMLSelectElement>, HTMLSelectElement>;
            small: InfernoJSX.DetailedHTMLProps<InfernoJSX.HTMLAttributes<HTMLElement>, HTMLElement>;
            source: InfernoJSX.DetailedHTMLProps<InfernoJSX.SourceHTMLAttributes<HTMLSourceElement>, HTMLSourceElement>;
            span: InfernoJSX.DetailedHTMLProps<InfernoJSX.HTMLAttributes<HTMLSpanElement>, HTMLSpanElement>;
            strong: InfernoJSX.DetailedHTMLProps<InfernoJSX.HTMLAttributes<HTMLElement>, HTMLElement>;
            style: InfernoJSX.DetailedHTMLProps<InfernoJSX.StyleHTMLAttributes<HTMLStyleElement>, HTMLStyleElement>;
            sub: InfernoJSX.DetailedHTMLProps<InfernoJSX.HTMLAttributes<HTMLElement>, HTMLElement>;
            summary: InfernoJSX.DetailedHTMLProps<InfernoJSX.HTMLAttributes<HTMLElement>, HTMLElement>;
            sup: InfernoJSX.DetailedHTMLProps<InfernoJSX.HTMLAttributes<HTMLElement>, HTMLElement>;
            table: InfernoJSX.DetailedHTMLProps<InfernoJSX.TableHTMLAttributes<HTMLTableElement>, HTMLTableElement>;
            tbody: InfernoJSX.DetailedHTMLProps<InfernoJSX.HTMLAttributes<HTMLTableSectionElement>, HTMLTableSectionElement>;
            td: InfernoJSX.DetailedHTMLProps<InfernoJSX.TdHTMLAttributes<HTMLTableDataCellElement>, HTMLTableDataCellElement>;
            textarea: InfernoJSX.DetailedHTMLProps<InfernoJSX.TextareaHTMLAttributes<HTMLTextAreaElement>, HTMLTextAreaElement>;
            tfoot: InfernoJSX.DetailedHTMLProps<InfernoJSX.HTMLAttributes<HTMLTableSectionElement>, HTMLTableSectionElement>;
            th: InfernoJSX.DetailedHTMLProps<InfernoJSX.ThHTMLAttributes<HTMLTableHeaderCellElement>, HTMLTableHeaderCellElement>;
            thead: InfernoJSX.DetailedHTMLProps<InfernoJSX.HTMLAttributes<HTMLTableSectionElement>, HTMLTableSectionElement>;
            time: InfernoJSX.DetailedHTMLProps<InfernoJSX.TimeHTMLAttributes<HTMLElement>, HTMLElement>;
            title: InfernoJSX.DetailedHTMLProps<InfernoJSX.HTMLAttributes<HTMLTitleElement>, HTMLTitleElement>;
            tr: InfernoJSX.DetailedHTMLProps<InfernoJSX.HTMLAttributes<HTMLTableRowElement>, HTMLTableRowElement>;
            track: InfernoJSX.DetailedHTMLProps<InfernoJSX.TrackHTMLAttributes<HTMLTrackElement>, HTMLTrackElement>;
            u: InfernoJSX.DetailedHTMLProps<InfernoJSX.HTMLAttributes<HTMLElement>, HTMLElement>;
            ul: InfernoJSX.DetailedHTMLProps<InfernoJSX.HTMLAttributes<HTMLUListElement>, HTMLUListElement>;
            "var": InfernoJSX.DetailedHTMLProps<InfernoJSX.HTMLAttributes<HTMLElement>, HTMLElement>;
            video: InfernoJSX.DetailedHTMLProps<InfernoJSX.VideoHTMLAttributes<HTMLVideoElement>, HTMLVideoElement>;
            wbr: InfernoJSX.DetailedHTMLProps<InfernoJSX.HTMLAttributes<HTMLElement>, HTMLElement>;

            // SVG
            svg: InfernoJSX.SVGProps<SVGSVGElement>;

            animate: InfernoJSX.SVGProps<SVGElement>; // TODO: It is SVGAnimateElement but is not in TypeScript's lib.dom.d.ts for now.
            animateTransform: InfernoJSX.SVGProps<SVGElement>; // TODO: It is SVGAnimateTransformElement but is not in TypeScript's lib.dom.d.ts for now.
            circle: InfernoJSX.SVGProps<SVGCircleElement>;
            clipPath: InfernoJSX.SVGProps<SVGClipPathElement>;
            defs: InfernoJSX.SVGProps<SVGDefsElement>;
            desc: InfernoJSX.SVGProps<SVGDescElement>;
            ellipse: InfernoJSX.SVGProps<SVGEllipseElement>;
            feBlend: InfernoJSX.SVGProps<SVGFEBlendElement>;
            feColorMatrix: InfernoJSX.SVGProps<SVGFEColorMatrixElement>;
            feComponentTransfer: InfernoJSX.SVGProps<SVGFEComponentTransferElement>;
            feComposite: InfernoJSX.SVGProps<SVGFECompositeElement>;
            feConvolveMatrix: InfernoJSX.SVGProps<SVGFEConvolveMatrixElement>;
            feDiffuseLighting: InfernoJSX.SVGProps<SVGFEDiffuseLightingElement>;
            feDisplacementMap: InfernoJSX.SVGProps<SVGFEDisplacementMapElement>;
            feDistantLight: InfernoJSX.SVGProps<SVGFEDistantLightElement>;
            feFlood: InfernoJSX.SVGProps<SVGFEFloodElement>;
            feFuncA: InfernoJSX.SVGProps<SVGFEFuncAElement>;
            feFuncB: InfernoJSX.SVGProps<SVGFEFuncBElement>;
            feFuncG: InfernoJSX.SVGProps<SVGFEFuncGElement>;
            feFuncR: InfernoJSX.SVGProps<SVGFEFuncRElement>;
            feGaussianBlur: InfernoJSX.SVGProps<SVGFEGaussianBlurElement>;
            feImage: InfernoJSX.SVGProps<SVGFEImageElement>;
            feMerge: InfernoJSX.SVGProps<SVGFEMergeElement>;
            feMergeNode: InfernoJSX.SVGProps<SVGFEMergeNodeElement>;
            feMorphology: InfernoJSX.SVGProps<SVGFEMorphologyElement>;
            feOffset: InfernoJSX.SVGProps<SVGFEOffsetElement>;
            fePointLight: InfernoJSX.SVGProps<SVGFEPointLightElement>;
            feSpecularLighting: InfernoJSX.SVGProps<SVGFESpecularLightingElement>;
            feSpotLight: InfernoJSX.SVGProps<SVGFESpotLightElement>;
            feTile: InfernoJSX.SVGProps<SVGFETileElement>;
            feTurbulence: InfernoJSX.SVGProps<SVGFETurbulenceElement>;
            filter: InfernoJSX.SVGProps<SVGFilterElement>;
            foreignObject: InfernoJSX.SVGProps<SVGForeignObjectElement>;
            g: InfernoJSX.SVGProps<SVGGElement>;
            image: InfernoJSX.SVGProps<SVGImageElement>;
            line: InfernoJSX.SVGProps<SVGLineElement>;
            linearGradient: InfernoJSX.SVGProps<SVGLinearGradientElement>;
            marker: InfernoJSX.SVGProps<SVGMarkerElement>;
            mask: InfernoJSX.SVGProps<SVGMaskElement>;
            metadata: InfernoJSX.SVGProps<SVGMetadataElement>;
            path: InfernoJSX.SVGProps<SVGPathElement>;
            pattern: InfernoJSX.SVGProps<SVGPatternElement>;
            polygon: InfernoJSX.SVGProps<SVGPolygonElement>;
            polyline: InfernoJSX.SVGProps<SVGPolylineElement>;
            radialGradient: InfernoJSX.SVGProps<SVGRadialGradientElement>;
            rect: InfernoJSX.SVGProps<SVGRectElement>;
            stop: InfernoJSX.SVGProps<SVGStopElement>;
            switch: InfernoJSX.SVGProps<SVGSwitchElement>;
            symbol: InfernoJSX.SVGProps<SVGSymbolElement>;
            text: InfernoJSX.SVGProps<SVGTextElement>;
            textPath: InfernoJSX.SVGProps<SVGTextPathElement>;
            tspan: InfernoJSX.SVGProps<SVGTSpanElement>;
            use: InfernoJSX.SVGProps<SVGUseElement>;
            view: InfernoJSX.SVGProps<SVGViewElement>;
        }
    }
}
